...
Device <small>Device Overview</small>
</h1>
<ol class="breadcrumb">
<li class="active">
<i class="fa fa-dashboard"></i> Device
</li>
</ol>
</div>
</div>
...
if(count($rows)>0) {
	for($i=0; $i<count($rows); $i++) {
		...
		<tr>
			...
			<td><input type="button" id="device_edit" name="device_edit" value="EDIT"><input type="button" id="device_delete" name="device_delete" value="DELETE"></td>
		</tr>
		<?php
