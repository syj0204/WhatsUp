	...
	<div class="row">
    	...
    	<div class="row">	
			...
			<div class="col-xs-2">
				...
				<div class="col-lg-12">
	    			<select name="list4" id="list4" size="11" style="display: none" multiple="multiple">
					</select>
				</div>
			</div>
			<!-- /.col-xs-2 -->	
			<div class="col-xs-3" align="center">
				<button id="add_permission" class="btn btn-default" type="button" style="display: none" >Add Permission</button>
