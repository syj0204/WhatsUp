...
?>
<link
	href="css/multiple-select.css" rel="stylesheet" type="text/css" />
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<i class="fa fa-bar-chart-o fa-fw"></i>Templates Match
						</h3>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-xs-12">
								<div class="col-xs-5">
									<label id="list1_title"><?php echo $han2?> </label><br> <select
										multiple="multiple" name="list1" id="list1"
										class="form-control">
								...
								<div class="col-xs-6">
									...
									<div class="form-group input-group">
										...
										</select> <span class="input-group-btn"><button id="enter"
									...
									<div class="col-xs-12">
										<label id="list20_title"><?php echo $han1?> </label> <select
											name="list20" id="list20" class="form-control" size="23.5"></select>
									</div>
								</div>
							</div>
						</div>
